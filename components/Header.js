...
const Header = () => {
  ...
  // Removed headerHeight to allow auto height for full bg coverage on wrap/mobile

  return (
    <header className={`sticky top-0 bg-white z-50 border-b border-gray-300 text-black`}> {/* Removed fixed height */}
      <div className="container mx-auto flex items-center justify-between py-4 px-4 md:px-8 flex-col md:flex-row"> {/* Added flex-col md:flex-row for better mobile stacking if wraps */}
        ...
        <nav className="flex flex-wrap gap-4 md:gap-6 items-center justify-center md:justify-end mt-4 md:mt-0"> {/* Added mt-4 md:mt-0 for spacing on mobile stack */}
