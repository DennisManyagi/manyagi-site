    ...
    <>
      ...
      <section className="bento-grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
        <Card>
          ...
          <button onClick={() => handleCheckout('price_1Rwfe5IFtQrr5DjcidsMeAON')} className="btn btn-capital mt-2">Pro ($99/mo)</button>
          <button onClick={handleBundleSubscribe} className="btn btn-capital mt-2">Bundle ($150/mo)</button>
        </Card>
        <Card>
      ...
      <aside className="social-widget mt-8 max-w-3xl mx-auto glass p-4 rounded">
        <h3 className="text-xl mb-4 kinetic">Latest from @ManyagiCapital</h3>
        <a className="twitter-timeline" data-height="400" href="https://twitter.com/ManyagiCapital?ref_src=twsrc%5Etfw">Tweets by ManyagiCapital</a>
