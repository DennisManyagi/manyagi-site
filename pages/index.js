  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data: prodData } = await supabaseAdmin.from('products').select('*').eq('status', 'active').limit(3);
  ...
  return (
    <>
      <Head>
        ...
        {siteConfig.favicon?.file_url && (
          <link rel="icon" href={siteConfig.favicon.file_url} />
        )}
      </Head>
      <Hero
        kicker="Welcome"
      ...
      <section id="divisions" className="container mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-3 gap-5">
        <Card
          ...
          image={siteConfig.publishing_hero || "/images/legacy-chapter-1.webp"}
          link="/publishing"
          category="publishing"
        />
        <Card
          ...
          image={siteConfig.designs_hero || "/images/mock-tee-1.webp"}
          link="/designs"
          category="designs"
        />
        <Card
          ...
          image={siteConfig.capital_hero || "/images/chart-hero.webp"}
          link="/capital"
          category="capital"
        />
        <Card
          ...
          image={siteConfig.tech_hero || "/images/daito-screenshot.webp"}
          link="/tech"
          category="tech"
        />
        <Card
          ...
          image={siteConfig.media_hero || "/images/og-media.webp"}
          link="/media"
          category="media"
        />
        <Card
          ...
          image={siteConfig.realty_hero || "/images/rental-bigbear.webp"}
          link="/realty"
          category="realty"
        />
      </section>
