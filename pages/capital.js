...
export default function Capital() {
    ...
    try {
      ...
      setProducts([
        { 
          ...
          price: 99.99, 
          image_url: 'https://dlbbjeohndiwtofitwec.supabase.co/storage/v1/object/public/assets/images/bot-license.webp', 
          division: 'capital', 
  ...
  if (loading) {
    return <div className="container mx-auto px-4 py-16 text-center">Loading capital products...</div>;
  }
    ...
    <>
      ...
      <section id="performance" className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          >
            <Link 
              href="https://www.myfxbook.com/members/Blackkungfu/manyagi-meanpulse/11661957" 
